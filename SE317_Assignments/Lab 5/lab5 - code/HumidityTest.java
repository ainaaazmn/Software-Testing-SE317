...
public class HumidityTest {
	...
	@Test 
	public void testHumidityUpperBoundaryFalse() {
	...
	@Test 
	public void testHumidityLowerBoundaryFalse() {
	...
	@Test 
	public void testHumidityUpperBoundaryCorrect() {
		
		HumidityTemperature.currentHumidity = 100;
		
		assertEquals(true, HumidityTemperature.isValidHumidity(HumidityTemperature.currentHumidity ));
	}
	
	@Test 
	public void testHumidityLowerBoundaryCorrect() {
		
		HumidityTemperature.currentHumidity = 0;
